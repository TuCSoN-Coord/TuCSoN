...
public class TupleViewer extends javax.swing.JFrame {
    ...
    private final alice.tuplecentre.tucson.introspection.InspectorContext context;
    ...
    public TupleViewer(final InspectorGUI mf) {
        ...
        this.setTitle("Logic tuples set copyOf tuplecentre < "
    ...
    private void initComponents() {
        ...
        this.tupleArea.setFont(new java.awt.Font("Courier New", Font.PLAIN, 12));
        ...
        settingsPane.setFont(new java.awt.Font("Arial", Font.PLAIN, 11));
