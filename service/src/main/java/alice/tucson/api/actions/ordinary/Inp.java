 ...
 *
 */
public class Inp extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code inp} action given its target tuple centre and
     * its tuple argument
     * 
     * @param tc
    ...
    public ITucsonOperation executeSynch(final EnhancedSynchACC acc,
        ...
        return acc.inp(this.tcid, this.tuple, timeout);
    }
