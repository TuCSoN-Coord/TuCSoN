 ...
 *
 */
public class In extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code in} action given its target tuple centre and its
     * tuple argument
     * 
     * @param tc
     ...
     */
    public In(final TucsonTupleCentreIdDefault tc, final LogicTuple t) {
        super(tc, t);
    }
    ...
    public TucsonOperation executeAsynch(final EnhancedAsyncACC acc,
        ...
        return acc.in(this.tcid, this.tuple, listener);
    }
    ...
    public TucsonOperation executeSynch(final EnhancedSyncACC acc,
        ...
        return acc.in(this.tcid, this.tuple, timeout);
    }
