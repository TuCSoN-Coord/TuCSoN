 ...
 *
 */
public class Rdp extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code rdp} action given its target tuple centre and
     * its tuple argument
     * 
     * @param tc
     ...
     */
    public Rdp(final TucsonTupleCentreIdDefault tc, final LogicTuple t) {
        super(tc, t);
    }
    ...
    public TucsonOperation executeSynch(final EnhancedSyncACC acc,
        ...
        return acc.rdp(this.tcid, this.tuple, timeout);
    }
