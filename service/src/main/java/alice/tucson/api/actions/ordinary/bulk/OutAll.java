 ...
 *
 */
public class OutAll extends AbstractTucsonOrdinaryAction {
     ...
     */
    public OutAll(final TucsonTupleCentreIdDefault tc, final LogicTuple t) {
        super(tc, t);
    }
    ...
    public TucsonOperation executeAsynch(final EnhancedAsyncACC acc,
        ...
        return acc.outAll(this.tcid, this.tuple, listener);
    }
