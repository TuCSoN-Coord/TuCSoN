 ...
 *
 */
public class Out extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code out} action given its target tuple centre and
     * its tuple argument
     * 
     * @param tc
     ...
     */
    public Out(final TucsonTupleCentreIdDefault tc, final LogicTuple t) {
        super(tc, t);
    }
    ...
    public TucsonOperation executeSynch(final EnhancedSyncACC acc,
        ...
        return acc.out(this.tcid, this.tuple, timeout);
    }
