 ...
 *
 */
public class Unop extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code uno} action given its target tuple centre and
     * its tuple argument
     * 
     * @param tc
     ...
     */
    public Unop(final TucsonTupleCentreIdDefault tc, final LogicTuple t) {
        super(tc, t);
    }
    ...
    public TucsonOperation executeAsynch(final EnhancedAsyncACC acc,
        ...
        return acc.unop(this.tcid, this.tuple, listener);
    }
    ...
    public TucsonOperation executeSynch(final EnhancedSyncACC acc,
        ...
        return acc.unop(this.tcid, this.tuple, timeout);
    }
