 ...
 *
 */
public class Rd extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code rd} action given its target tuple centre and its
     * tuple argument
     * 
     * @param tc
     ...
     */
    public Rd(final TucsonTupleCentreIdDefault tc, final LogicTuple t) {
        super(tc, t);
    }
    ...
    public TucsonOperation executeAsynch(final EnhancedAsyncACC acc,
        ...
        return acc.rd(this.tcid, this.tuple, listener);
    }
    ...
    public TucsonOperation executeSynch(final EnhancedSyncACC acc,
        ...
        return acc.rd(this.tcid, this.tuple, timeout);
    }
