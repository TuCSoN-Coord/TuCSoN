 ...
 *
 */
public class NopS extends AbstractTucsonSpecificationAction {

    /**
     * Builds the TuCSoN {@code nop_s} action given its target tuple centre
     * 
     * @param tc
     ...
     *            specification tuple
     */
    public NopS(final TucsonTupleCentreIdDefault tc, final LogicTuple e,
