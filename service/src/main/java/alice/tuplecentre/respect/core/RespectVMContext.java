...
public class RespectVMContext extends alice.tuplecentre.core.AbstractTupleCentreVMContext {
	...
	private void log(final String s) {
        System.out.println("....[RespectVMContext (" + ((alice.tuplecentre.respect.api.TupleCentreId) this.getId()).getName() + "@"
                + ((alice.tuplecentre.respect.api.TupleCentreId) this.getId()).getNode() + ":"
                + ((alice.tuplecentre.respect.api.TupleCentreId) this.getId()).getPort() + ")]: " + s);
	}
