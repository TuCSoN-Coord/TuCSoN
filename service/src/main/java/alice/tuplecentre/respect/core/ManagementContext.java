...
public class ManagementContext implements IManagementContext {
     ...
     * (non-Javadoc)
     * @see
     * alice.tuplecentre.respect.api.IManagementContext#disablePersistence(alice.tuplecentre.tucson.
     ...
     * (non-Javadoc)
     * @see
     * alice.tuplecentre.respect.api.IManagementContext#enablePersistence(alice.tuplecentre.tucson.api
     * .TucsonTupleCentreId)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * alice.tuplecentre.respect.api.IManagementContext#recoveryPersistent(alice.tuplecentre.tucson.
     * api.TucsonTupleCentreId)
     */
    @Override
