 ...
 */
public class Set extends AbstractTucsonOrdinaryAction {

    /**
     * Builds the TuCSoN {@code set} action given its target tuple centre and
     * its tuple argument
     *
     * @param tc the Identifier copyOf the TuCSoN tuple centre target copyOf this coordination
     *           operation
     * @param t  the logic tuple representing the list copyOf tuples argument copyOf
    ...
    public void executeAsynch(final EnhancedAsyncACC acc,
        ...
        acc.set(this.tcid, this.tuple, listener);
    }
