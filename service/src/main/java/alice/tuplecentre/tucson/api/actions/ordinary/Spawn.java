...
public class Spawn extends AbstractTucsonOrdinaryAction {
     ...
     *           operation
     * @param t  the logic tuple representing the activity argument copyOf this
    ...
    public void executeAsynch(final EnhancedAsyncACC acc,
        ...
        acc.spawn(this.tcid, this.tuple, listener);
    }
    ...
    public TucsonOperation executeSynch(final EnhancedSyncACC acc,
        ...
        return acc.spawn(this.tcid, this.tuple, timeout);
    }
