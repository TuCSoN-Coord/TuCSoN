 ...
 * proxy {@link alice.tuplecentre.tucson.service.ACCProxyAgentSide agent} and the TuCSoN
 * Node Service proxy {@link alice.tuplecentre.tucson.service.ACCProxyNodeSide node}. It
 * actually triggers the latter proxy creation by the ACC Provider
 * {@link alice.tuplecentre.tucson.service.ACCProvider provider} spawned by the Tucson Node
 * Service {@link alice.tuplecentre.tucson.service.TucsonNodeService TuCSoN}
 *
 * @see alice.tuplecentre.tucson.service.ACCProxyAgentSide ACCProxyAgentSide
 * @see alice.tuplecentre.tucson.service.ACCProxyNodeSide ACCProxyNodeSide
 * @see alice.tuplecentre.tucson.service.ACCProvider ACCProvider
