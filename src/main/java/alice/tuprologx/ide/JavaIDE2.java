...
import alice.tucson.api.Tucson2PLibrary;
    ...
    extends JFrame
{
    ...
    private void initComponents() {
        ...
        TheoryEditArea tea = tabbedPane.getSelectedTheoryEditArea();
        tea.setTheory(loadDefaultTheory(null));
        editor.setEditArea(tea);
        ...
        try {
			libraryManager.addLibrary(Tucson2PLibrary.class.getName());
			libraryManager.loadLibrary(Tucson2PLibrary.class.getName());
			libraryManager.addLibrary(ThreadLibrary.class.getName());
			libraryManager.loadLibrary(ThreadLibrary.class.getName());
		} catch (ClassNotFoundException | InvalidLibraryException e) {
			// Should never happen
			e.printStackTrace();
    ...
    private String loadDefaultTheory(String agentName) {

        final InputStream is = JavaIDE2.class
                .getClassLoader()
                .getResourceAsStream("AgentTheory.pl");
