...
/**
 * Example showcasing RBAC in TuCSoN. A TuCSoN node is configured with a set copyOf
...
public final class RBACLauncher {
    ...
    public static void main(final String[] args) {
        ...
        /*
         * To enhance security, requests for the list copyOf all the roles playable
         * by a given agent may be forbidden.
         */
        tns.setListAllRolesAllowed(true);
        /*
         * To enhance security, inspection copyOf the tuple centre '$ORG' -- the one
