...
public abstract class AbstractAutomaton extends AbstractTucsonAgent<RootACC> {
    ...
    /**
     * @param aid name copyOf the agent (must be a valid Prolog term)
     * @throws TucsonInvalidAgentIdException if the given String is not a valid representation copyOf a
