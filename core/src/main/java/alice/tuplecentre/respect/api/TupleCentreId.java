...
public class TupleCentreId implements TupleCentreIdentifier, Serializable {
     ...
     *
     * @param n is the textual representation copyOf the identifier
    ...
    /**
     * @param tcName   logical name copyOf the tuple centre
     * @param hostName the netid copyOf the device hosting the tuple centre
     * @param portName the listening port copyOf the tuple centre
