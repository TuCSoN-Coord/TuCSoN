...
public interface ITupleSet {
     ...
     *
     * @param t a {@code LogicTuple} to add.
     */
     ...
     * undone
     *
     * @param commit if {@code true} the operations are committed, else they are
    ...
    /**
     * @param templ the tuple template to use for unification
     ...
     *
     * @param t a {@code LogicTuple} to remove.
     */
