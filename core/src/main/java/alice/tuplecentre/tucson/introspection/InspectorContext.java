...
public interface InspectorContext {
    ...
    /**
     * adds a new listener to the events generated by this context
     *
     * @param l the listener copyOf inspection events to add
     */
    ...
    /**
     * gets a snapshot copyOf tuple set
     *
     * @param snapshotType the type copyOf snapshot the inspector wants to receive
     * @throws DialogSendException if something goes wrong in the underlying network
     */
    void getSnapshot(final GetSnapshotMessage.SetType snapshotType) throws DialogSendException;

    /**
     * @return the identifier copyOf the tuple centre under inspection
     */
     ...
     *
     * @param l the listener copyOf inspection events to remove
     */
    ...
    /**
     * sets the entire content copyOf the events set
     *
     * @param tset the list copyOf tuples representing events to overwrite current
     *             InQ with
     * @throws DialogSendException if something goes wrong in the underlying network
     */
    ...
    /**
     * sets the entire content copyOf the tuple set
     *
     * @param tset the list copyOf tuples to overwrite current tuple set with
     * @throws DialogSendException if something goes wrong in the underlying network
     */
    void setTupleSet(final List<Tuple> tset) throws DialogSendException;

    /**
     * do the next step copyOf the VM
     *
     * @throws DialogSendException if the VM is not reachable due to network problems
     */
